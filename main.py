...
def GetResults():
    ...
    largest_number_result = session.execute(text('SELECT instanceName, MAX(generatedNumber) AS largest_number FROM NumbersGenerated GROUP BY instanceName, generatedNumber')).fetchone()
    ...
    smallest_number_result = session.execute(text('SELECT instanceName, MIN(generatedNumber) AS smallest_number FROM NumbersGenerated GROUP BY instanceName, generatedNumber')).fetchone()
